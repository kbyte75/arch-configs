...
## Based on original by Keyitdev https://github.com/Keyitdev/one-piece
...
readonly THEME_REPO="https://github.com/Keyitdev/one-piece.git"
readonly THEME_NAME="one-piece"
...
preview_theme(){
    ...
    sddm-greeter-qt6 --test-mode --theme /usr/share/sddm/themes/one-piece/ > $log_file 2>&1 &
    greeter_pid=$!
